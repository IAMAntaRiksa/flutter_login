...
class _LoginScreenState extends State<LoginScreen> {
  ...
  @override
  void initState() {
    context.read<LoginBloc>().add(InitAppCheckLogIng());
          ...
          showDialog(
            ...
            builder: (context) {
              return const AlertDialog(
                title: Text('User/passord'),
                content: Text('Password or username failed'),
              );
            },
          );
        } else if (state is LoginFaildetoHome) {
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: const Padding(
                                    padding: EdgeInsets.symmetric(vertical: 16),
                                    child: Text('Register', style: textFontses),
                                  ),
                                ),
                              ),
                            ),
